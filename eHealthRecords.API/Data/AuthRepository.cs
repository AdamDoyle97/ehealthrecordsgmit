...
// tells class were using IAuth
    public class AuthRepository : IAuthRepository
    {
        ...
        {
            var user = await _context.Users.Include(p => p.Photos).Include(x=>x.Role).FirstOrDefaultAsync(x => x.Username == username); //will return matching username or null if no match
